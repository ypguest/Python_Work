...
if __name__ == '__main__':
    url_path = r"//arctis/qcxpub/QRE/04_QA(Component)/99_Daily_Report/99_QRE_CP_Yield_Report/CP_Map_Report/7.28Daily_Report_Map_Gallery.html"
    data_path = r"//arctis/qcxpub/QRE/04_QA(Component)/99_Daily_Report/99_QRE_CP_Yield_Report/CP_Map_Report/7.28_LOT LIST.xlsx"
