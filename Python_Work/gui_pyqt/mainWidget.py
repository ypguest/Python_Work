...
class MainWidget(QWidget):
    def __init__(self):
        ...
        self.ProdQuery3.sendToMainL3.connect(self.ProdQuery1.sendMsg)      # 功能按钮被单击，触发sendMeg函数
        self.ProdQuery3.sendToMainL3.connect(self.ProdQuery2.sendMsg)      # 功能按钮被单击，触发sendMeg函数
